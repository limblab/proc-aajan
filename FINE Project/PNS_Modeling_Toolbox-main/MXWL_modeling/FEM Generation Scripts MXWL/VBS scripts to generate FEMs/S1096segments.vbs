...
ModelName = "E:\ICNerveModels\S109_Median7Frame39_6segments\" & ModelNameShort
FascCoordsFileName = "E:\ICNerveModels\S109_Median7Frame39_6segments\M7T39_NoEncap_fasccoords.txt"
VoutFileName = "E:\ICNerveModels\S109_Median7Frame39_6segments"
NumFascicles = 13
...
for contact_number = 5 to 5
	...
	oDesktop.OpenProject "E:\ICNerveModels\16 channel with anode strip CFINE_10x125.mxwl"
	Set oProject = oDesktop.SetActiveProject("16 channel with anode strip CFINE_10x125")
	...
	do while not objFileToRead.AtEndOfStream
		for fascicle_number = 1 to NumFascicles
			...
			oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Geometry3DCmdTab", Array("NAME:PropServers", "Endo" & fascicle_number & ":CreateRegularPolyhedron:1"), Array("NAME:ChangedProps", Array("NAME:Center Position", "X:=", "$Endo" & fascicle_number & "X", "Y:=", "$Endo" & fascicle_number & "Y", "Z:=", "-30mm"), Array("NAME:Start Position", "X:=", "$Endo" & fascicle_number & "X+$Endo" & fascicle_number & "R", "Y:=", "$Endo" & fascicle_number & "Y", "Z:=", "-30mm"))))
			oEditor.DuplicateAlongLine Array("NAME:Selections", "Selections:=", "Endo" & fascicle_number, "NewPartsModelFlag:=", "Model"), Array("NAME:DuplicateToAlongLineParameters", "CreateNewObjects:=", true, "XComponent:=", "0mm", "YComponent:=", "0mm", "ZComponent:=", "10mm", "NumClones:=", "6"), Array("NAME:Options", "DuplicateAssignments:=", false)
			...
			oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Geometry3DCmdTab", Array("NAME:PropServers", "Peri" & fascicle_number & ":CreateRegularPolyhedron:1"), Array("NAME:ChangedProps", Array("NAME:Center Position", "X:=", "$Peri" & fascicle_number & "X", "Y:=", "$Peri" & fascicle_number & "Y", "Z:=", "-30mm"), Array("NAME:Start Position", "X:=", "$Peri" & fascicle_number & "X+$Peri" & fascicle_number & "R", "Y:=", "$Peri" & fascicle_number & "Y", "Z:=", "-30mm"))))
			oEditor.DuplicateAlongLine Array("NAME:Selections", "Selections:=", "Peri" & fascicle_number, "NewPartsModelFlag:=", "Model"), Array("NAME:DuplicateToAlongLineParameters", "CreateNewObjects:=", true, "XComponent:=", "0mm", "YComponent:=", "0mm", "ZComponent:=", "10mm", "NumClones:=", "6"), Array("NAME:Options", "DuplicateAssignments:=", false)
		next
	loop
	'Epi
	...
	oEditor.ChangeProperty Array("NAME:AllTabs", Array("NAME:Geometry3DCmdTab", Array("NAME:PropServers", "Epineurium:CreateBox:1"), Array("NAME:ChangedProps", Array("NAME:Position", "X:=", "-$cuff_length_inner/2 + $encapsulation_thickness", "Y:=", "-$cuff_height_inner/2 + $encapsulation_thickness", "Z:=", "-30mm"), Array("NAME:XSize", "Value:=", "$cuff_length_inner - 2*$encapsulation_thickness"), Array("NAME:YSize", "Value:=", "$cuff_height_inner - 2*$encapsulation_thickness"), Array("NAME:ZSize", "Value:=", "10mm"))))
	oEditor.DuplicateAlongLine Array("NAME:Selections", "Selections:=", "Epineurium", "NewPartsModelFlag:=", "Model"), Array("NAME:DuplicateToAlongLineParameters", "CreateNewObjects:=", true, "XComponent:=", "0mm", "YComponent:=", "0mm", "ZComponent:=", "10mm", "NumClones:=", "6"), Array("NAME:Options", "DuplicateAssignments:=", false)
   ...
   Set objFileToRead = Nothing
	...
	oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "Encapsulation", "Tool Parts:=", "Epineurium_1,Epineurium_2,Epineurium_3,Epineurium_4"), Array("NAME:SubtractParameters", "KeepOriginals:=", true)
