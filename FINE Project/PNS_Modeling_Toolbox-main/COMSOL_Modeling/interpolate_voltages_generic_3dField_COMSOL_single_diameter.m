function [ Vext, axonXPositions, axonYPositions, axonDiameters ] = interpolate_voltages_generic_3dField_COMSOL_single_diameter( template_voltages, center_z_pos, polygon_file, axons_per_fascicle, fiberD )
